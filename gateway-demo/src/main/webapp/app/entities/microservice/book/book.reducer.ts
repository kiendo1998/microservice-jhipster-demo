...
import { IBook, defaultValue } from 'app/shared/model/microservice/book.model';
...
const apiUrl = 'services/microservice/api/books';
const apiSearchUrl = 'services/microservice/api/_search/books';
